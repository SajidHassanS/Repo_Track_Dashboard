  ...
  return (
    <div className="h-screen overflow-y-auto flex flex-col lg:flex-row">
      ...
      <div className="lg:w-2/3 bg-[#090D28] flex flex-col items-center justify-center p-4 text-white shadow-lg relative">
        <h2 className="text-3xl mb-6">Create New Account</h2>
        <h6 className="text-sm mb-6">Enter your details to create an account.</h6>
        ...
        <form className="w-full max-w-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <img src={loginbtn} alt="Sign Up Button" />
            </button>
        ...
        <p className="lg:absolute lg:top-0 lg:right-0 lg:text-right lg:text-green-500 lg:mt-4 lg:mr-4">Already have an account? Sign In</p>
      </div>
    </div>
  );
}
