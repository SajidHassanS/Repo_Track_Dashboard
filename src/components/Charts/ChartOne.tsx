...
const ChartOne: React.FC = () => {
  ...
  return (
    <div className="col-span-3 xl:col-span-2 rounded-2xl dark:border  px-5 pt-7.5 pb-5 shadow-default border-strokedark bg-bodydark1 dark:bg-[#eb5431] sm:px-7.5 " >
