    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full md:w-2/5 bg-white flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          <h2 className="text-3xl text-center text-black font-bold mb-6">Find Your Account</h2>
          <p className="text-xl text-center text-black mb-6">Please enter your email address to search for your account.</p>
