    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full md:w-2/5 bg-white flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          <h2 className="text-3xl text-center text-black font-bold mb-6">Password Changed!</h2>
          <p className="text-xl text-center text-black mb-6">Your Password has been changed successfully.</p>
          <p className="mt-3 text-center">
            Already have an account?<Link to="/" className="text-blue-600 hover:text-blue-700">Sign In </Link>
          </p>
        </div>
      </div>
    </div>
